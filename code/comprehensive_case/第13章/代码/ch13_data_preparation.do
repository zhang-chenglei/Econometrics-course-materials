...
estpost summarize rd_intensity_w ln_patent_invention size lev roa growth ///
    fixed cashflow firm_age ln_gov_subsidy kz_index sa_index ln_rd_staff
esttab using "$PKG/第13章/表格/stata_描述性统计.csv", ///
...
graph export "$PKG/第13章/图形/stata_图13-2a_研发投入原始趋势.png", width(2200) replace
...
graph export "$PKG/第13章/图形/stata_图13-2b_专利原始趋势.png", width(2200) replace
restore
