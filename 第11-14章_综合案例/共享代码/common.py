...
MATERIALS_DIR = PACKAGE_DIR.parents[1]
DATA_PATH = (
    MATERIALS_DIR
    / "data/semisynthetic/ai_pilot_semisynthetic_2011_2024.csv"
)
POLICY_PATH = MATERIALS_DIR / "data/policy/case_policy_approvals.csv"
