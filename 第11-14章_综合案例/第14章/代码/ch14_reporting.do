...
esttab m1 m2 m3 m4 using "$PKG/第14章/表格/stata_表14-1_TWFE最终版.rtf", ///
...
graph export "$PKG/第14章/图形/stata_图14-1_TWFE主结果.png", width(2200) replace

* 注意：正式交错DID表和事件研究图以第13章csdid输出或Python输出为准。
