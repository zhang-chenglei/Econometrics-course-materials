...
graph export output/ch04-fig4-ai-score-curve.png, width(1800) replace
...
marginsplot, recast(line) recastci(rarea) ///
    title("AI 使用与成绩：不同性别的两组斜率") ///
    xtitle("每周 AI 使用时间（小时）") ytitle("预测对数成绩")
graph export output/ch04-fig5-ai-gender.png, width(1800) replace
